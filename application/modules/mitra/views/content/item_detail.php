...
<!--                </div>-->
                <div class="product-page-cart">
                    <a href="javascript:;" class="btn btn-primary add2cart" onclick="add_to_catalog(<?php echo $item['id'];?>)">Add to Catalog</a>
                </div>
                <div class="review">
                    ...
                    <div class="tab-pane fade in active">
                        ...
                        <form id="form_add" class="reviews-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="<?php echo $nama_reseller ?>" readonly>
                            </div>
