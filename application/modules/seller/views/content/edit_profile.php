            ...
            <div class="col-md-10 col-sm-10">
                <form enctype="multipart/form-data" class="form-horizontal form-without-legend" id="form_edit_user">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control required" id="provinsi" name="provinsi">
                               <?php
                               if($data_alamat){
                                   $getAlamat = $this->db->get_where('r_provinsi',array('id'=>$data_alamat['provinsi']))->row_array();
                                   echo "<option value='".$data_alamat['provinsi']."'>".$getAlamat['nama']."</option>";
                               }else{
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control required" id="kabupaten" name="kabupaten">
                                <?php
                                if($data_alamat){
                                    $getAlamat = $this->db->get_where('r_kabupaten',array('id'=>$data_alamat['kabupaten']))->row_array();
                                    echo "<option value='".$data_alamat['kabupaten']."'>".$getAlamat['nama']."</option>";
                                }else{
                                    echo "<option value=''>Pilih</option>";
                                }?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control required" id="kecamatan" name="kecamatan">
                                <?php
                                if($data_alamat){
                                    echo "<option value='".$data_alamat['kecamatan']."'>".$data_alamat['kecamatan']."</option>";
                                }else{
                                    echo "<option value=''>Pilih</option>";
                                }?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea name="alamat" id="alamat" class="form-control required" rows="5"><?php if($data_alamat){ echo $data_alamat['alamat'];}?></textarea>
                        </div>
                    </div>
