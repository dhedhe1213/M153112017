            ...
            <table style="width: 100%; text-align: center; border-top: 1px solid #F1F1F2; border-bottom: 1px solid #F1F1F2; padding: 15px 0;" width="100%" cellspacing="0" cellpadding="0">
                ...
                ?>
                        <tr style="font-size: 13px;">
                            ...
                            <td style="width: 120px; padding: 8px 5px;" width="120"><?php echo $row['qty']; ?></td>
                            ...
                            <td style="width: 115px; text-align: right; padding: 8px 30px 8px 5px;" width="115"><?php echo number_format($getItemHarga['harga_fix']*$row['qty'],0); ?></td>
                        </tr>
                <?php
                    }
                }
