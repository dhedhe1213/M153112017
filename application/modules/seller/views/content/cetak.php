...
<table width="790" cellspacing="0" cellpadding="0" class="container" style="width: 790px; padding: 20px;">
    <tr>
        <td>
            ...
            <b>Kode</b>    <?php echo $kode_unik['code']; ?>
            <br><br>
            <table style="width: 100%; text-align: center; border-top: 1px solid #F1F1F2; border-bottom: 1px solid #F1F1F2; padding: 15px 0;" width="100%" cellspacing="0" cellpadding="0">
                ...
                if($data){
                    ...
                    foreach($data as $row){
                        ...
                        $subTotalItem[] = $getItemHarga['harga_fix']*$data_transaksi_item['qty'];
                        $beratTotal[] = $getItem['berat']*$data_transaksi_item['qty'];
                ?>
                        <tr style="font-size: 13px;">
                            ...
                            <td style="width: 115px; text-align: right; padding: 8px 30px 8px 5px;" width="115"><?php echo number_format($getItemHarga['harga_fix']*$data_transaksi_item['qty'],0); ?></td>
                        </tr>
                <?php
                    }
                }
