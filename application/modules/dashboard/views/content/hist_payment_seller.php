                        ...
                        if($data){
                            ...
                            foreach($data as $row){
                                ...
                                <tr>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            if($getIdPayment){
                                                ...
                                                foreach($getIdPayment as $data){
                                                    $getIdTransaksi = $this->db->get_where('m_transaksi_item',array('id_transaksi'=>$data['id_transaksi'],'id_seller'=>$row['id_user']))->result_array();
                                                    if($getIdTransaksi){
                                                        ...
                                                        foreach($getIdTransaksi as $data2){
                                                            ...
                                                            $getOngkir = $this->db->group_by('id_transaksi')->get_where('m_transaksi_item',array('id_transaksi'=>$data['id_transaksi']))->result_array();
                                                            $totalOngkir = array();
                                                            if($getOngkir){
                                    ...
                                    <td><?php echo number_format($totalKomisiCount,0); reset($totalKomisi);reset($totalOngkir);?></td>
